...
kable(head(sleepstudy), digits = 2, caption = "Example data") %>% 
  kable_styling()
```
...
```{r fig1and2, fig.cap = "Scatterplots with a completely pooled model (left), and individual specific models (right).", echo = TRUE, preview = TRUE, layout = "l-body-outset", fig.width = 8}
...
```{r plotlmer, layout = "l-body-outset", fig.width = 8}
