...
request(
  "http://127.0.0.1:23119/better-bibtex/export/collection?/1/matti-vuorre.bibtex"
) |>
  req_perform() |>
  resp_body_string() |>
...
dat <- request(
  "http://127.0.0.1:23119/better-bibtex/export/collection?/1/matti-vuorre.jzon"
) |>
  req_perform() |>
  resp_body_string() |>
  fromJSON() |>
...
# Readings
request(
  "http://127.0.0.1:23119/better-bibtex/export/collection?/1/4C5A7RQL.jzon"
) |>
  req_perform() |>
  resp_body_string() |>
  fromJSON() |>
